...
void FiveRuleTestTree() {
    ...
    delete(test1); 
    if(test3.getChild()[0]->getRootLabel() == 3){
    ...
    if(testAssignment.getChild()[0]->getRootLabel()  == 3)
    ...
    if(testMove2.getChild()[0]->getRootLabel() == 5 && testMove1.getChild().size() == 0)
    ...
    if(testMove2.getChild()[0]->getRootLabel() == 5 )
